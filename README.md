...
1. Run the skill to decompose the requirement into user stories and specifications for each of them. It will generate an `index-spec.md` file containing the execution order of the specs, an `open-questions.md` file to resolve inconsistencies, ambiguities, and other issues that arose during decomposition, and a `solution-diagrams.md` file with sequence, class, and other supporting technical design diagrams of the solution.
